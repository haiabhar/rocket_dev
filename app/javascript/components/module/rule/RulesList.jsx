...
{ property: 'category_name', header: 'Category' },
{ property: 'rule_type_name', header: 'Rule Type' },
...
{ property: 'show_btn', header: 'Show', render: datum => <ShowRule user={user} rule_detail={datum} setData={setData} /> },
