...
var convertArg = function convertArg(spel, conv, config, meta, parentSpel) {
  ...
  if (spel.type == "compound") {
    ...
    // todo: get from conv
    var funcToOpMap = (_funcToOpMap = {}, (0, _defineProperty2["default"])(_funcToOpMap, ".contains", "like"), (0, _defineProperty2["default"])(_funcToOpMap, ".startsWith", "starts_with"), (0, _defineProperty2["default"])(_funcToOpMap, ".endsWith", "ends_with"), (0, _defineProperty2["default"])(_funcToOpMap, "$contains", "select_any_in"), (0, _defineProperty2["default"])(_funcToOpMap, ".equals", "multiselect_equals"), (0, _defineProperty2["default"])(_funcToOpMap, "CollectionUtils.containsAny()", "multiselect_contains"), _funcToOpMap);
    ...
    if (methodName == "contains" && obj && obj[0].type == "list") {
      ...
      var fieldConfig = (0, _configUtils.getFieldConfig)(config, _field3);
      ...
      var _fieldConfig = (0, _configUtils.getFieldConfig)(config, _field4);
...
var convertToTree = function convertToTree(spel, conv, config, meta) {
  ...
  if (spel.type.indexOf("op-") == 0) {
    ...
    if (op == "and" || op == "or") {
      ...
      var opKey = opKeys[0];
      if (opKeys.length > 1) {
        _stuff.logger.warn("[spel] Spel operator ".concat(op, " can be mapped to ").concat(opKeys));
