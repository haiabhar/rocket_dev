...
var widgets = {
  text: {
    ...
    formatValue: function formatValue(val, fieldDef, wgtDef, isForDisplay) {
      return isForDisplay ? (0, _export.stringifyForDisplay)(val) : JSON.stringify(val);
    },
  ...
  multiselect: {
    ...
    formatValue: function formatValue(vals, fieldDef, wgtDef, isForDisplay) {
      ...
      return isForDisplay ? valsLabels.map(_export.stringifyForDisplay) : vals.map(JSON.stringify);
    },
