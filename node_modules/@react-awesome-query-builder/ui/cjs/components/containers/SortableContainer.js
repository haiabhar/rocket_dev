...
exports["default"] = exports._isReorderingTree = void 0;
...
var getFlatTree = _core.Utils.TreeUtils.getFlatTree;
var _isReorderingTree = false;
exports._isReorderingTree = _isReorderingTree;
  ...
  return _class = /*#__PURE__*/function (_Component) {
    ...
    function SortableContainer(props) {
      ...
      _this.onDragStart = function (id, dom, e) {
        ...
        if (_this._isUsingLegacyReactDomRender === undefined) {
          _this._isUsingLegacyReactDomRender = (0, _reactUtils.isUsingLegacyReactDomRender)(treeEl);
        }
    ...
    (0, _createClass2["default"])(SortableContainer, [{
      ...
      value: function componentDidUpdate(_prevProps, _prevState) {
        ...
        exports._isReorderingTree = _isReorderingTree = false;
      ...
      value: function move(fromII, toII, placement, toParentII) {
        if (!this._isUsingLegacyReactDomRender) {
          exports._isReorderingTree = _isReorderingTree = true;
        }
